...
export type DownloadFinancialsData = {
    body?: never;
    path?: never;
    query?: {
        order?: 'asc' | 'desc';
...
export type DownloadFinancialsResponses = {
    /**
     * Response
     */
    200: Blob | File;
...
export type DownloadFinancialsResponse = DownloadFinancialsResponses[keyof DownloadFinancialsResponses];
